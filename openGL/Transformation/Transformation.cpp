...
int main(int argc, char** argv)
{
    ...
    unsigned int transformLoc = glGetUniformLocation(OwOShader.ID,"transform");
    ...
    /**/
        // trans = glm::rotate(trans, glm::radians(radian), glm::vec3(0.0, 0.0, 1.0));
        trans = glm::mat4(1.0f);
        trans = glm::rotate(trans, (float)glfwGetTime()/10, glm::vec3(0.0f, 1.0f, 0.0f));
        trans = glm::rotate(trans, (float)glfwGetTime()/10, glm::vec3(1.0f, 1.0f, 0.0f));
