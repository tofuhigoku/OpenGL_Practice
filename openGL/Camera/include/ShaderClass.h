...
public:
    ...
    void setMat4(const string &name, glm::mat4 model) const;
...
void ShaderClass::setMat4(const string &name, glm::mat4 model) const
{
    int MAT4_loc =  glGetUniformLocation(ID, name.c_str());
    glUniformMatrix4fv(MAT4_loc, 1, GL_FALSE, glm::value_ptr(model));
